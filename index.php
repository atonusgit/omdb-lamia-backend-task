...
$basePipe->request( "/help", function ( Request $req, Response $res ) {
	...
	$res->sendText(
		...
		"\n\t2. Send POST request to /login, with username and password attached to request body" .
...
$basePipe->request( "/", function ( Request $req, Response $res ) {
	...
	$res->sendText( "Try /help endpoint to get help." );
